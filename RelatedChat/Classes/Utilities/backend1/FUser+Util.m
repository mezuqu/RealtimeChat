...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (([self[FUSER_FIRSTNAME] length] != 0) && ([self[FUSER_LASTNAME] length] == 0)) return [self[FUSER_FIRSTNAME] substringToIndex:1];
	if (([self[FUSER_FIRSTNAME] length] == 0) && ([self[FUSER_LASTNAME] length] != 0)) return [self[FUSER_LASTNAME] substringToIndex:1];
	//---------------------------------------------------------------------------------------------------------------------------------------------
